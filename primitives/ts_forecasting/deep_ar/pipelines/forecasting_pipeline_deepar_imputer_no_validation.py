...
step_7.add_hyperparameter(name="window_size", argument_type=ArgumentType.VALUE, data=20)
step_7.add_hyperparameter(name="epochs", argument_type=ArgumentType.VALUE, data=1)
step_7.add_hyperparameter(name="steps_per_epoch", argument_type=ArgumentType.VALUE, data=5)
step_7.add_output("produce")
pipeline_description.add_step(step_7)

# Step 8: construct predictions
