...
# Step 4 DISTIL/NK t-SNE primitive -> dimensionality reduction
step_4 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.dimensionality_reduction.t_distributed_stochastic_neighbor_embedding.Tsne'))
step_4.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.3.produce')
step_4.add_hyperparameter(name='n_components', argument_type=ArgumentType.VALUE,data=3)
