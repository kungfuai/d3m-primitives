...
def show_cam_on_image(
    image, img: np.ndarray, mask: np.ndarray, mask_strength: float = 0.4
):
    img = deshape(img)
    img = (img / 4096) ** 0.5
...
all_images, label_encoder, tgts = load_inputs(
    "/test_data/bigearth-100-single-multi/*/*.tif"
)
