...
def test_confidence_intervals_dataset_terra_canopy():
    _test_confidence_intervals('LL1_terra_canopy_height_long_form_s4_100_MIN_METADATA')
...
def test_confidence_intervals_dataset_terra_leaf():
    _test_confidence_intervals('LL1_terra_leaf_angle_mean_long_form_s4_MIN_METADATA')
...
def test_confidence_intervals_dataset_phem_monthly():
    _test_confidence_intervals('LL1_PHEM_Monthly_Malnutrition_MIN_METADATA')
...
def test_confidence_intervals_dataset_phem_weekly():
    _test_confidence_intervals('LL1_PHEM_weeklyData_malnutrition_MIN_METADATA')
