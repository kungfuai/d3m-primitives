...
setup(
    ...
    install_requires=[
        ...
        "object_detection_retinanet @ git+https://github.com/uncharted-distil/object-detection-retinanet@df87aa8f99303991f820863823a144a123a25811#egg=object_detection_retinanet",
        "Simon @ git+https://github.com/uncharted-distil/simon@00422bbdc9caa09b867f8b5f583487b59b605de0#egg=Simon",
        "nk_sent2vec @ git+https://github.com/uncharted-distil/nk-sent2vec@41cd72ffa7c3ade0aca873ba7816f82875e66730#egg=nk_sent2vec",
        "duke @ git+https://github.com/uncharted-distil/duke@71de4875a2d6dbd8b0b384d108aff4d3724cc12f#egg=duke",
